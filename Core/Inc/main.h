...
#define HDMI_TX_RST_Pin GPIO_PIN_12
#define HDMI_TX_RST_GPIO_Port GPIOB
#define HDMI_TX_INT_Pin GPIO_PIN_13
#define HDMI_TX_INT_GPIO_Port GPIOB
#define STATUS_LED_Pin GPIO_PIN_14
#define STATUS_LED_GPIO_Port GPIOB
#define REC_LED_Pin GPIO_PIN_15
#define REC_LED_GPIO_Port GPIOB
#define REC_SW_Pin GPIO_PIN_8
