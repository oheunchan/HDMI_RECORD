...
// #define CONFIG_SPDINFOFRAME_SMAPLE

#define SUPPORT_EDID
#define SUPPORT_HDCP /*20221226*/
#define SUPPORT_SHA
//#define SUPPORT_AUDIO_MONITOR
#define AudioOutDelayCnt 250

// #define SUPPORT_CEC/*20221228*/
...
#define SUPPORT_SYNCEMBEDDED	//oec20240615
// #define SUPPORT_DEGEN
#define NON_SEQUENTIAL_YCBCR422/*20230918*/

// #define SET_OUTPUT_COLORMODE_BY_EDID /*20221219*/

//#define INPUT_COLOR_MODE F_MODE_RGB444
#define INPUT_COLOR_MODE F_MODE_YUV422	//oec20240615
...
// #define USING_IT66120 1
// #define USE_IT66120 1
#ifdef USING_IT66120
    ...
    //   #define INPUT_SIGNAL_TYPE 0x00 // 24 bit sync seperate
    // #define INPUT_SIGNAL_TYPE ( T_MODE_DEGEN )
  	// #define INPUT_SIGNAL_TYPE ( T_MODE_INDDR) // half bus
    //  #define INPUT_SIGNAL_TYPE ( T_MODE_INDDR|T_MODE_PCLKDIV2) // full bus DDR
...
#define USE_SPDIF_CHSTAT
    ...
    #else
        #define OUTPUT_CHANNEL 8 // 3 // 4 // 5//6 //7 //8
    #endif
...
#define HDMITX_AUTO_MONITOR_INPUT   /*20221219*/
...
#define CUSTOM_HDMI_ISW 0x3 // valid value: 0~7
#define CUSTOM_DVI_ISW 0x3 // valid value: 0~7

#define FORCE_DEVICE_VERSION FALSE/*20230220*/

// #define IT66120
#if FORCE_DEVICE_VERSION/*20230220*/
    #define FIX_DEVICE_VERSION   0x22
    // #define FIX_DEVICE_VERSION   0x21
#endif
#endif
