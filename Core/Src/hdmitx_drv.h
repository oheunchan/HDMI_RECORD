...
#define REG_TX_AFE_DRV_CTRL 0x61
    ...
    #define B_TX_AFE_DRV_TERMON	(1<<1)

#define REG_TX_DRV_ISW	0x63
#define O_TX_DRV_ISW	(3)
#define M_TX_DRV_ISW	(7<<O_TX_DRV_ISW)


// Input Data Format Register
#define REG_TX_INPUT_MODE  0x70
    // #define O_TX_INCLKDLY	0
    // #define M_TX_INCLKDLY	3/*20230523 : B0 ver Reg chg*/
...
#define REG_TX_SPD_INFOFRM_CTRL 0xC9 /*20230210*/
...
// Source Product Description Info Frame using NULL packet /*202330210*/
#define REG_TX_PKT_SPDINFO_SUM 0x3B
#define REG_TX_PKT_SPDINFO_PB1 0x3C
#define REG_TX_PKT_SPDINFO_PB2 0x3D
#define REG_TX_PKT_SPDINFO_PB3 0x3E
#define REG_TX_PKT_SPDINFO_PB4 0x3F
#define REG_TX_PKT_SPDINFO_PB5 0x40
#define REG_TX_PKT_SPDINFO_PB6 0x41
#define REG_TX_PKT_SPDINFO_PB7 0x42
#define REG_TX_PKT_SPDINFO_PB8 0x43
#define REG_TX_PKT_SPDINFO_PB9 0x44
#define REG_TX_PKT_SPDINFO_PB10 0x45
#define REG_TX_PKT_SPDINFO_PB11 0x46
#define REG_TX_PKT_SPDINFO_PB12 0x47
#define REG_TX_PKT_SPDINFO_PB13 0x48
#define REG_TX_PKT_SPDINFO_PB14 0x49
#define REG_TX_PKT_SPDINFO_PB15 0x4A
#define REG_TX_PKT_SPDINFO_PB16 0x4B
#define REG_TX_PKT_SPDINFO_PB17 0x4C
#define REG_TX_PKT_SPDINFO_PB18 0x4D
#define REG_TX_PKT_SPDINFO_PB19 0x4E
#define REG_TX_PKT_SPDINFO_PB20 0x4F
#define REG_TX_PKT_SPDINFO_PB21 0x50
#define REG_TX_PKT_SPDINFO_PB22 0x51
#define REG_TX_PKT_SPDINFO_PB23 0x52
#define REG_TX_PKT_SPDINFO_PB24 0x53
#define REG_TX_PKT_SPDINFO_PB25 0x54
...
/////////////////////////////////////////////////////////////////////////////////////
void InitHDMITX();
BYTE GetInputSignalType();//20221212
void HDMITX_InitTxDev(const HDMITXDEV *pInstance);
BYTE CheckHDMITX(BYTE *pHPD,BYTE *pHPDChange, BYTE *pParameterChange); //oec20240929
...
void hdmitx_Change_XP_Setting(VIDEOPCLKLEVEL pre_level);/*20231114*/	//oec20240929
...
BOOL HDMITX_EnableSPDInfoFrame(BYTE bEnable,BYTE *pSPDInfoFrame);/*20230210*/
