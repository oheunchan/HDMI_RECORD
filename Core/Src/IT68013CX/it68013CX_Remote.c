...
void IRHandler(void)
{
    ...
    if(g_keyQue!=NO_KEY)
    {
        MxLRX_DEBUG_PRINTF(("!!! IRHandler() !!!g_keyQue= %X\n", (int) g_keyQue));
        switch(g_keyQue)
        {
            case  IR_HDMI1_CODE:
                it6802PortSelect(0);
...
//                IT6802ChangeTTLVideoOutputMode();
//FIX_ID_003 xxxxx
//                break;
            ...
            case  IR_PWR_CODE:
                IT6802_CECPowerOffByIT680X(1);
                break;

            case  IR_NO4_CODE:
                IT6802_CECPowerOnByIT680X(0);
                it6802PortSelect(0);
                break;
            case  IR_NO5_CODE:
            case  IR_NO6_CODE:
                IT6802_CECPowerOnByIT680X(1);
                it6802PortSelect(1);
                break;
    #endif
//FIX_ID_005 xxxxx    //Add CsigBus Event Handler
// disable ->            case IR_REW_CODE:        IT6802MSCCmdTest(B_DevCapChange); break;
// disable ->            case IR_PLAY_CODE:        IT6802MSCCmdTest(B_HPD); break;
// disable ->            case IR_PAUSE_CODE:        IT6802MSCCmdTest(B_PATH_EN); break;
// disable ->            case IR_FFORWARD_CODE:    IT6802MSCCmdTest(B_Set_DCAP_RDY); break;

// disable ->            case IR_Up_CODE:        IT6802MSCCmdTest(0x10); break;
// disable ->            case IR_Down_CODE:        IT6802MSCCmdTest(0x20); break;
// disable ->            case IR_Left_CODE:        IT6802MSCCmdTest(0x40); break;
// disable ->            case IR_Right_CODE:        IT6802MSCCmdTest(0x80); break;
//FIX_ID_005 xxxxx
